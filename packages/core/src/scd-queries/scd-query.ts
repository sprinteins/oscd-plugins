...
export class SCDQueries {
	...
	public searchGSEs(options?: CommonOptions): GSEElement[] {
		return this.searchElement<GSEElement>(
			SCDQueries.SelectorGSE,
			['ldInst', 'cbName'],
			options
		)
	}
	...
	public searchIEDs(options?: CommonOptions): IEDElement[] {
		return this.searchElement<IEDElement>(
			SCDQueries.SelectorIED,
			SCDQueries.AttributeListIED,
			options
		)
	}
	...
	public searchBays(options?: CommonOptions): BayElement[] {
		return this.searchElement<BayElement>(
			SCDQueries.SelectorBay,
			SCDQueries.AttributeListBay,
			options
		)
	}
	...
	public getBaysByIEDName(name: string): Set<string> {
		...
		for (const lnode of lnodes) {
			if (lnode != null) {
				...
				if (bayName != null) connections.add(bayName)
			}
		}
	...
	public getSubnetworksByIEDName(name: string): Set<Element> {
		...
		for (const connectedAP of connectedAPs) {
			if (connectedAP != null) {
				...
				if (bay != null) connections.add(bay)
			}
		}
	...
	public searchInputs(options?: CommonOptions): InputElement[] {
		return this.searchElement<InputElement>(
			SCDQueries.SelectorInput,
			[],
			options
		)
	}
	...
	public searchGSE(
		...
		const elements = this.searchElement<GSEElement>(
			selector,
			['cbName', 'ldInst'],
			options
		)
	...
	public searchElementsParentSubnetwork(
		element: Element
	): Optional<SubNetworkElement> {
	...
	public searchDOTypes(options?: CommonOptions): DOTypeElement[] {
		return this.searchElement<DOTypeElement>(
			SCDQueries.SelectorDOType,
			['id'],
			options
		)
	}
	...
	public searchDATypes(options?: CommonOptions): DATypeElement[] {
		return this.searchElement<DATypeElement>(
			SCDQueries.SelectorDAType,
			['id'],
			options
		)
	}
	...
	public searchEnumTypes(options?: CommonOptions): EnumTypeElement[] {
		return this.searchElement<EnumTypeElement>(
			SCDQueries.SelectorEnumType,
			['id'],
			options
		)
	}
	...
	public searchDOsByType(type: string, options?: CommonOptions): DOElement[] {
		...
		return this.searchElement<DOElement>(
			selector,
			['name', 'type'],
			options
		)
	...
	public searchLNodeTypes(options?: CommonOptions): LNodeTypeElement[] {
		return this.searchElement<LNodeTypeElement>(
			SCDQueries.SelectorLNodeType,
			['id', 'lnClass'],
			options
		)
	}
	...
	public searchReportControls(
		...
		return this.searchElement<ReportControlElement>(
			SCDQueries.SelectorReportControl,
			['rptID', 'name', 'datSet'],
			options
		)
	}
	...
	public searchElementsParentIED(element: Element): Optional<IEDElement> {
		...
		const parentIED = this.searchElementParent<IEDElement>(
			element,
			parentSelector,
			SCDQueries.AttributeListIED
		)
	...
	public searcClientLNs(options?: CommonOptions): ClientLNElement[] {
		return this.searchElement<ClientLNElement>(
			SCDQueries.SelectorClientLN,
			['iedName'],
			options
		)
	}

	public searchElementsByTypeAttr(
		type: string,
		options?: CommonOptions
	): SCDElement[] {
	...
	public searchElementsByLnTypeAttr(
		type: string,
		options?: CommonOptions
	): SCDElement[] {
	...
	public searchConnectedAPIP(
		options?: CommonOptions
	): ConnectedAPIPElement | undefined {
	...
	public static AttributeListIPSubnet: AttributeList<ConnectedAPIPSubnetElement>[] =
		[]
	public searchConnectedAPIPSubnet(
		options?: CommonOptions
	): ConnectedAPIPSubnetElement | undefined {
	...
	public static AttributeListIPGateway: AttributeList<ConnectedAPIPGatewayElement>[] =
		[]
	public searchConnectedAPIPGateway(
		options?: CommonOptions
	): ConnectedAPIPGatewayElement | undefined {
		const ipGatewayElements =
			this.searchElement<ConnectedAPIPGatewayElement>(
				SCDQueries.SelectorIPGateway,
				SCDQueries.AttributeListIPGateway,
				options
			)
	...
	public static AttributeListCable: AttributeList<ConnectedAPCableElement>[] =
		[]
	public searchConnectedAPCables(
		options?: CommonOptions
	): ConnectedAPCableElement[] {
		const cableElements = this.searchElement<ConnectedAPCableElement>(
			SCDQueries.SelectorCable,
			SCDQueries.AttributeListCable,
			options
		)
	...
	public static AttributeListGooseAddress: AttributeList<ConnectedAPGooseAddressElement>[] =
		[]
	public searchConnectedAPGooseAddresses(
		options?: CommonOptions
	): ConnectedAPGooseAddressElement[] {
		const gooseAddressElements =
			this.searchElement<ConnectedAPGooseAddressElement>(
				SCDQueries.SelectorGooseAddress,
				SCDQueries.AttributeListGooseAddress,
				options
			)
	...
	public static AttributeListSampledValuesAddress: AttributeList<ConnectedAPSampledValuesAddressElement>[] =
		[]
	public searchConnectedAPSampledValuesAddresses(
		options?: CommonOptions
	): ConnectedAPSampledValuesAddressElement[] {
		const gooseAddressElements =
			this.searchElement<ConnectedAPSampledValuesAddressElement>(
				SCDQueries.SelectorSampledValuesAddress,
				SCDQueries.AttributeListSampledValuesAddress,
				options
			)
	...
	public static AttributeListVLanId: AttributeList<AddressVLanIdElement>[] =
		[]
	public searchAddressVLanId(
		options?: CommonOptions
	): AddressVLanIdElement | null {
		const vLanIdElement = this.searchSingleElement<AddressVLanIdElement>(
			SCDQueries.SelectorAddressVLanId,
			SCDQueries.AttributeListVLanId,
			options
		)
	...
	public static AttributeListMacAddress: AttributeList<AddressMacAddressElement>[] =
		[]
	public searchAddressMacAddress(
		options?: CommonOptions
	): AddressMacAddressElement | null {
		const macAddressElement =
			this.searchSingleElement<AddressMacAddressElement>(
				SCDQueries.SelectorAddressMacAddress,
				SCDQueries.AttributeListMacAddress,
				options
			)
	...
	public static AttributeListPhysConnection: AttributeList<ConnectedAPPhyConnectionElement>[] =
		[]
	public seachConnectedPhysConnections(
		options?: CommonOptions
	): ConnectedAPPhyConnectionElement[] {
		const physConnections =
			this.searchElement<ConnectedAPPhyConnectionElement>(
				SCDQueries.SelectorPhysConnection,
				SCDQueries.AttributeListPhysConnection,
				options
			)
	...
	public seachPhysConnectionCable(
		options?: CommonOptions
	): ConnectedAPCableElement | null {
		return this.searchSingleElement<ConnectedAPCableElement>(
			SCDQueries.SelectorPhysConnectionCable,
			SCDQueries.AttributeListCable,
			options
		)
	}
	...
	public static AttributeListPort: AttributeList<ConnectedAPPortElement>[] =
		[]
	public seachPhysConnectionPort(
		options?: CommonOptions
	): ConnectedAPPortElement | null {
		return this.searchSingleElement<ConnectedAPPortElement>(
			SCDQueries.SelectorPhysConnectionPort,
			SCDQueries.AttributeListPort,
			options
		)
	}
	...
	public static AttributeListType: AttributeList<ConnectedAPPortElement>[] =
		[]
	public seachPhysConnectionType(
		options?: CommonOptions
	): ConnectedAPPortElement | null {
		return this.searchSingleElement<ConnectedAPTypeElement>(
			SCDQueries.SelectorPhysConnectionType,
			SCDQueries.AttributeListType,
			options
		)
	}
	...
	public static AttributeListPlug: AttributeList<ConnectedAPPlugElement>[] =
		[]
	public seachPhysConnectionPlug(
		options?: CommonOptions
	): ConnectedAPPlugElement | null {
		return this.searchSingleElement<ConnectedAPPlugElement>(
			SCDQueries.SelectorPhysConnectionPlug,
			SCDQueries.AttributeListPlug,
			options
		)
	}
	...
	// Privates
	//
	private searchElement<T extends SCDElement>(
		selector: string,
	...
	private searchSingleElement<T extends SCDElement>(
		selector: string,
		attributeList: AttributeList<T>[],
		options?: CommonOptions
	): T | null {
...
function createElement<T extends SCDElement>(
	el: Element,
	attributeList: AttributeList<T>[]
): T {
