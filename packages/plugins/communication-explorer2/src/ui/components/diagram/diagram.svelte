<script lang="ts">
	import type {
		...
		IEDElkNode,
		RootNode
	} from '@oscd-plugins/ui'
	import { isBayNode } from '@oscd-plugins/ui'
	...
	import {
		...
		isIEDSelected,
	} from '../../../headless/stores/filter-store.js'
	...
	$: resetZoom(rootNode.width || 0, rootNode.height || 0)
...
{#if rootNode}
	...
	>
		<svg
			bind:this={svgRoot}
			on:keypress
			viewBox={`0 0 ${rootNode.width || 0} ${rootNode.height || 0}`}
