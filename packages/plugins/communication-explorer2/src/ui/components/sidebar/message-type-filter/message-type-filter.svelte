...
import { setTargetMessageType } from '../../../../headless/index.js'
...
function isSelected(messageType: string, selectedTypes: string[], clicked: boolean): boolean {
...
<div class="message-type">
    <label>
        ...
        <div class="message-label">
            <div class="icon">
                <!-- Icon placeholder - will be addressed when porting icon system -->
                <span>📡</span>
            </div>
...
<style>
    ...
    .message-type label input[disabled] + div.message-label .text {
