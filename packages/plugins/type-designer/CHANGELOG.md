...
- Keep malformed SCL types visible and isolated so valid types remain editable

## [3.17.0] - 2026-09-09

### Added

- Automated test setup based on Vitest, jsdom and Playwright
- Unit tests for Type Designer headless helpers and stores
- Integration tests for type, reference and import workflows
- Playwright end-to-end smoke tests for plugin loading and Bay Type filtering
- V8 coverage reporting for Type Designer headless logic

### Changed

- Type Designer CI now runs unit and integration tests before the build
- Type Designer CI generates and uploads the coverage report as an artifact
