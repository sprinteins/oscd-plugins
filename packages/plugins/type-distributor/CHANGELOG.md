...
## [1.1.2] - 2026-09-09
### Added
- CI workflows for dependency installation, build, lint, and test quality checks.
### Changed
- Updated test and coverage commands for CI execution.
### Fixed
- Corrected Lucide Svelte import paths in the import dialog.
