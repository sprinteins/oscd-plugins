...
describe('getOrCreateDataTypeTemplates', () => {
	...
	describe('GIVEN a document without DataTypeTemplates', () => {
		describe('WHEN getOrCreateDataTypeTemplates is called', () => {
			it('THEN should create a new DataTypeTemplates element', () => {
				...
				// WHEN
				const result = getOrCreateDataTypeTemplates(mockDocument)
	...
	describe('GIVEN a document with existing DataTypeTemplates', () => {
		...
		describe('WHEN getOrCreateDataTypeTemplates is called', () => {
			...
			it('THEN should not create a duplicate element', () => {
				...
				// WHEN
				getOrCreateDataTypeTemplates(mockDocument)
	...
	describe('GIVEN multiple calls to getOrCreateDataTypeTemplates', () => {
		describe('WHEN called on the same document', () => {
			it('THEN should return the same element on subsequent calls', () => {
				// GIVEN & WHEN
				const result1 = getOrCreateDataTypeTemplates(mockDocument)
				mockDocument.documentElement.appendChild(result1.element)
				const result2 = getOrCreateDataTypeTemplates(mockDocument)
