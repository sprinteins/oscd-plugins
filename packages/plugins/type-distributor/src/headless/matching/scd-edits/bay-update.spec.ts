	...
	describe('GIVEN an SCD Bay element with existing uuid', () => {
		describe('WHEN createBayUpdateEdit is called', () => {
			it('THEN should preserve the existing uuid', () => {
				...
				// WHEN
				const result: SetAttributes = createBayUpdateEdit(scdBay, bayType)
