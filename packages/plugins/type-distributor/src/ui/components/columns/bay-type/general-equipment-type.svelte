...
interface Props {
	...
	generalEquipment: GeneralEquipmentTemplate
	bayTypeInstanceUuid: string
}

const { eqFunction, generalEquipment, bayTypeInstanceUuid }: Props = $props()
...
const geLabel = $derived(`${eqFunction.name} (${generalEquipment.name})`)
</script>
